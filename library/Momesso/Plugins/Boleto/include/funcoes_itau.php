...
//Guarda inicial
?><img src="http://www.mercancia.com.br/default/imagens/boleto/p.png"" width=<?php echo $fino?> height=<?php echo $altura?> border=0><img
src="hhttp://www.mercancia.com.br/default/imagens/boleto/b.png" width=<?php echo $fino?> height=<?php echo $altura?> border=0><img
src="http://www.mercancia.com.br/default/imagens/boleto/p.png"" width=<?php echo $fino?> height=<?php echo $altura?> border=0><img
src="http://www.mercancia.com.br/default/imagens/boleto/b.png" width=<?php echo $fino?> height=<?php echo $altura?> border=0><img
<?php
$texto = $valor ;
if((strlen($texto) % 2) <> 0){
	$texto = "0" . $texto;
...
?>
    src="http://www.mercancia.com.br/default/imagens/boleto/p.png" width=<?php echo $f1?> height=<?php echo $altura?> border=0><img
<?php
    if (substr($f,$i,1) == "0") {
      $f2 = $fino ;
    }else{
...
// Draw guarda final
?>
src="http://www.mercancia.com.br/default/imagens/boleto/p.png" width=<?php echo $largo?> height=<?php echo $altura?> border=0><img
src="http://www.mercancia.com.br/default/imagens/boleto/b.png" width=<?php echo $fino?> height=<?php echo $altura?> border=0><img
src="http://www.mercancia.com.br/default/imagens/boleto/p.png" width=<?php echo 1?> height=<?php echo $altura?> border=0>
  <?php
} //Fim da função
